...
function Game() {
    ...
    {
        title: "Крутые игры",
        description: "Kamish предлагает множество игр, в которые вы можете играть на своём сервере! Сейчас в боте насчитывается более 12 мини-игр, а также доступны такие игры, как Мафия и Акинатор. Все остальные игры вы можете посмотреть и опробовать в самом боте!",
        embed: (
			<DiscordMessages>
