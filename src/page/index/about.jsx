        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 translate-y-4 ml-4 lg:ml-0 mr-4 lg:mr-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start text-center">
              <a href={link_bot} className="border border-[#2a2a2a] hover:bg-[#2a2a2a]/10 bg-[#2a2a2a] px-6 py-3 rounded-md text-[20px] font-medium transition duration-300 ease-in-out">Начать использовать</a>
              <a href="/docs" className="border border-[#2a2a2a] hover:bg-[#2a2a2a] px-6 py-3 rounded-md text-[20px] font-medium transition duration-300 ease-in-out">Подробнее</a>
            </div>
          </div>
          ...
          <div className="flex-1 relative scale-95">
            <div className="relative w-full aspect-square max-w-md mx-auto">
              ...
              <div className="relative z-10 w-full h-full">
                <img src="/photo/Kamish-avatar.png" alt="Kamish Bot" className="absolute inset-0 m-auto object-contain"/>
              </div>
            </div>
          </div>
        </div>
